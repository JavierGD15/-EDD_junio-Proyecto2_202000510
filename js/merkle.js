        ...
        if (raiz != null) {
            ...
            for (var i = 0; i < raiz.hash.length; i++) {
                if(x ==30){
                    ...
                    ayuda_texto += raiz.hash.charAt(i)+"\n";
                    x = 0;
                }else{
                    ayuda_texto += raiz.hash.charAt(i);
                    x++;
            ...
            this.texto += raiz.hash + " -> " + raiz.izquierdo.hash+ ";";
            this.texto +=raiz.hash + " -> " + raiz.derecho.hash+ ";";
            
            
            this.preOrden1(raiz.izquierdo);
